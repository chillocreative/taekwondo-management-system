                                        ...
                                        <table className="min-w-full divide-y divide-gray-200">
                                            <thead className="bg-gray-50">
                                                <tr>
                                                    ...
                                                    <th className="px-6 py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Tarikh Bayaran</th>
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200">
                                                {student.child?.monthly_payments?.map((payment, idx) => (
                                                    <tr key={idx} className={payment.is_paid ? 'bg-green-50/20' : 'hover:bg-gray-50'}>
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-right border-r">
