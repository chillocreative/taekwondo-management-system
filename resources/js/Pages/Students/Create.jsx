...
export default function Create({ auth }) {
    ...
    const [kategoris, setKategoris] = useState(Array(12).fill('kanak-kanak'));
    ...
    const submit = (e) => {
        ...
        router.post(route('students.store'), submitData, {
            onSuccess: () => {
                setProcessing(false);
            },
            onError: (errors) => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Tambah Pelajar Baru</h2>}
        >
            <Head title="Tambah Pelajar Baru" />
                                ...
                                <div className="mb-8">
                                    <div className="flex justify-between items-start mb-6">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="text-xl font-bold text-gray-400">Auto</div>
                                        </div>
                                    </div>
